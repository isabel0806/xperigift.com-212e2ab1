...
import { LayoutDashboard, BarChart3, Users, Mail, Settings, LogOut, Building2, ScanLine, Gift, FileText } from 'lucide-react';
        ...
        <aside className="hidden md:flex w-64 shrink-0 flex-col border-r border-hairline bg-paper">
          ...
          <nav className="flex-1 px-3 py-4">
            <ul className="space-y-1">
              ...
              <NavItem to="/dashboard/templates" label="Templates" icon={FileText} />
            </ul>
